...
//this is selecting a container where my "fav restuarants" are going to
let favRestaurantsDiv = document.querySelector("#favRestaurants");
...
function displayRestaurant () {
    ...
    for (let i = 0; i < storedFavRestaurants.length; i++) {
        ...
        const restaurant = storedFavRestaurants[i];
